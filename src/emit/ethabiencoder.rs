...
impl<'a, 'b> EncoderBuilder<'a, 'b> {
    ...
    fn encode_packed_ty(
        ...
        match &ty {
            ...
            {
                let n = match ty {
                    ast::Type::Contract(_) => ns.address_length as u16 * 8,
                    ast::Type::Uint(b) => *b,
                    ast::Type::Int(b) => *b,
                    _ => unreachable!(),
                };
            ...
            ast::Type::Address(_) => {
                let n = ns.address_length as u16 * 8;
    ...
    fn encode_primitive(
        ...
        match ty {
            ...
            ast::Type::Address(_) => {
                ...
                let dest = unsafe { binary.builder.build_gep(dest, &[binary.context.i64_type().const_int(12, false)], "") };
        ...
        *offset = new_offset;
        ...
        match &ty {
            ...
            ast::Type::Address(_) => {
                ...
                let data = unsafe { binary.builder.build_gep(data, &[binary.context.i64_type().const_int(12, false)], "") };
